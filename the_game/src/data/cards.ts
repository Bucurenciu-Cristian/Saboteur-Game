...
export const CardTypes = {
  ACTIONS: {
    ...
    DESTROY: `${ACTIONS_PATH}/destroyPath.png`, // Add other action cards here...
  },
  BACK_OF_CARDS: {
    PATH_OR_ACTION: `${BACK_OF_CARDS_PATH}/pathOrAction.png`,
    PLAYERS: `${BACK_OF_CARDS_PATH}/players.png`,
    WINNING: `${BACK_OF_CARDS_PATH}/winning.png`, // WINNING: '/images/SaboteurImagesSingle/Back_of_cards/winning.png',
    REWARD: `${BACK_OF_CARDS_PATH}/reward.png`,
    Start2: `${BACK_OF_CARDS_PATH}/start2.png`, // Add other back_of_cards here...
  },
